...
const deleteUploadedFile = async (filePath: string | null): Promise<void> => {
    if (filePath) {
...
const deleteEmployeeImage = async (imagePath: string | null): Promise<void> => {
...
export const registetEmployee = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const getEmployeeProfile = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
    try {
...
export const getEmployeeByName = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const getEmployeeByPhone = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const updateEmployeeProfileImage = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
...
export const updateEmployee = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
    try {
        const idValidation = employeeValidator.validateEmployeeId(req.params.id);
