...
import {
    ...
    validateForgotCustomerPassword,
...
const deleteCustomerImage = async (imagePath: string | null): Promise<void> => {
...
export const getProfile = async (req: CustomerAuthRequest, res: Response): Promise<void> => {
    try {
...
export const updateCustomerProfile = async (req: CustomerAuthRequest, res: Response): Promise<void> => {
    try {
        const customerId = getAuthenticatedCustomerId(req);
...
export const changePassword = async (req: CustomerAuthRequest, res: Response): Promise<void> => {
    try {
        const customerId = getAuthenticatedCustomerId(req);
        ...
        const passwordChanged = await changeCustomerPassword(
            customerId,
...
export const updateProfileImage = async (req: CustomerAuthRequest, res: Response): Promise<void> => {
