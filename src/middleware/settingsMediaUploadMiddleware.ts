...
const createMediaUploader = (folderName: string,allowedMimeTypes: string[],maximumFileSize: number,) => {
...
export const uploadLogo = createMediaUploader(
  "settings",
  ["image/jpeg", "image/png", "image/webp", "image/svg+xml"],
  5 * 1024 * 1024,
);

export const uploadHeroMedia = createMediaUploader(
  "theme",
