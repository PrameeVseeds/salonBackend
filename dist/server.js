...
async function startServer() {
    try {
        ...
        try {
            ...
            console.warn("Email service is unavailable. The API will start, but email features will fail until SMTP credentials are corrected.");
        ...
        const appointmentStatusTimer = setInterval(() => {
            void processTimedAppointmentStatuses().catch((error) => console.error("Failed to process timed appointment statuses:", error));
