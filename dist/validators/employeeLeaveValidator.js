...
export const validateLeaveDate = (value) => {
    if (value === undefined)
...
export const validateEmployeeLeave = (body) => {
    ...
    if (!employee.isValid)
        return { isValid: false, message: "A valid employee ID is required." };
...
//# sourceMappingURL=employeeLeaveValidator.js.map