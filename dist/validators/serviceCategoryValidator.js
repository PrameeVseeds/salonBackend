...
export const validateServiceCategoryId = (value) => {
    if (Array.isArray(value))
        return { isValid: false, message: "Invalid service category ID." };
    const id = Number(value);
    return Number.isInteger(id) && id > 0
        ? { isValid: true, data: id }
        : { isValid: false, message: "Invalid service category ID." };
};
export const validateServiceCategory = (body) => {
...
//# sourceMappingURL=serviceCategoryValidator.js.map