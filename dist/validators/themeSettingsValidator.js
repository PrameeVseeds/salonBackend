...
export const validateThemeSettings = (body) => {
    ...
    const heroMediaType = getString(body.heroMediaType ?? body.hero_media_type);
    if (!primaryColor ||
        !secondaryColor ||
        !accentColor ||
...
//# sourceMappingURL=themeSettingsValidator.js.map